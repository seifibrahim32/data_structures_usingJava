...
public class DynamicArray {
        ...
        public static class IntArray implements Iterable<Integer> {
            ...
            public int get(int index) {
                if(index < 1){
                    throw new IllegalArgumentException("No index will negative");
                }
                else if(isEmpty()){
                    throw new IllegalArgumentException("It is empty set");
                }
